...
class NeuralNet_Example(Scene):
    def construct(self):
        ...
        WTshades = [TEAL_E, BLUE_E, TEAL_D, BLUE_D]
        ...
        erreq = Tex('\\frac{1}{2} \\times (y-\hat y)^2').next_to(error, RIGHT).set_color(RED)
        ...
        self.wait(2)
        self.clear()
        final_ans = Tex('After\\ Iteration\\ 2,\\ The\\ final\\ weights\\ are: ')
